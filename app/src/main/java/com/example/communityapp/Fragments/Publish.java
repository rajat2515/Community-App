...
import com.example.communityapp.databinding.FragmentPublishBinding;
...
public class Publish extends Fragment {
    ...
    private void showsettingdialog() {
        ...
        builder.setMessage("This app needs permission to use this feature. You can grant us these permissions manually by clicking on below button");
